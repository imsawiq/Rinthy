export const ru = {
  ...
  modpack_creator: 'Создатель паков',
  modpack_name: 'Название пака',
  modpack_version: 'Версия пака',
  modpack_summary: 'Краткое описание',
  modpack_game: 'Игра',
  modpack_files: 'Файлы',
  modpack_add_file: 'Добавить мод/файл',
  modpack_export: 'Экспорт .mrpack',
  modpack_no_files: 'Файлы не добавлены.',
  modpack_search_placeholder: 'Поиск модов...',
  modpack_file_path: 'Путь к файлу',
  modpack_env_client: 'Клиент',
  modpack_env_server: 'Сервер',
  modpack_required: 'Обязательно',
  modpack_optional: 'Опционально',
  modpack_unsupported: 'Не поддерживается',
  modpack_remove_file: 'Удалить',
  modpack_exporting: 'Экспорт...',
  modpack_exported: 'Пак успешно экспортирован!'
} as const;
