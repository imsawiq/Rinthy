export const en = {
  ...
  modpack_summary: 'Pack Summary',
  modpack_game: 'Game',
  modpack_files: 'Files',
  modpack_add_file: 'Add Mod/File',
  modpack_export: 'Export .mrpack',
  modpack_no_files: 'No files added yet.',
  modpack_search_placeholder: 'Search for mods...',
  modpack_file_path: 'File Path',
  modpack_env_client: 'Client',
  modpack_env_server: 'Server',
  modpack_required: 'Required',
  modpack_optional: 'Optional',
  modpack_unsupported: 'Unsupported',
  modpack_remove_file: 'Remove',
  modpack_exporting: 'Exporting...',
  modpack_exported: 'Pack exported successfully!'
} as const;
